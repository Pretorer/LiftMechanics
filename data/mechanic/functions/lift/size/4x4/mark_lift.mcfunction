...
execute positioned ~3 ~ ~ run summon minecraft:marker ~ ~ ~ {Tags: ["lift_corner_marker"]}
execute positioned ~ ~ ~3 run summon minecraft:marker ~ ~ ~ {Tags: ["lift_corner_marker"]}
execute positioned ~3 ~ ~3 run summon minecraft:marker ~ ~ ~ {Tags: ["lift_corner_marker"]}
...
execute positioned ~3 ~ ~ run scoreboard players operation @e[tag=lift_corner_marker,distance=..0.2] SML.id = last_lift SML.id
execute positioned ~ ~ ~3 run scoreboard players operation @e[tag=lift_corner_marker,distance=..0.2] SML.id = last_lift SML.id
execute positioned ~3 ~ ~3 run scoreboard players operation @e[tag=lift_corner_marker,distance=..0.2] SML.id = last_lift SML.id

# set size
scoreboard players set @e[tag=lift_marker,distance=..0.2] SML.size 4
