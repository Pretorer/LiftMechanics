...
execute unless block ~4 ~ ~ chain run scoreboard players set result SML.variables 0
execute unless block ~ ~ ~4 chain run scoreboard players set result SML.variables 0
execute unless block ~4 ~ ~4 chain run scoreboard players set result SML.variables 0
