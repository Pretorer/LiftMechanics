...
# display ray
execute if score var SML.debug matches 1 run particle end_rod ~ ~ ~ 0 0 0 0 1 force
execute if score var SML.debug matches 2 at @e[tag=ray_hit_marker,limit=1] align xyz run summon falling_block ~0.5 ~ ~0.5 {BlockState: {Name: "minecraft:glass"}, Tags: ["ray_hit_marker_outline"], Time: -2147483648, NoGravity: 1b, Glowing: 1b}
