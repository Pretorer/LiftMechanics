...
scoreboard players operation @s SML.count += tmp SML.count
execute store result score tmp SML.count run data get block ~ ~ ~ Items[{id: "minecraft:iron_chain", Slot: 5b}].count
scoreboard players operation @s SML.count += tmp SML.count
execute store result score tmp SML.count run data get block ~ ~ ~ Items[{id: "minecraft:iron_chain", Slot: 6b}].count
scoreboard players operation @s SML.count += tmp SML.count
execute store result score tmp SML.count run data get block ~ ~ ~ Items[{id: "minecraft:iron_chain", Slot: 7b}].count
scoreboard players operation @s SML.count += tmp SML.count
execute store result score tmp SML.count run data get block ~ ~ ~ Items[{id: "minecraft:iron_chain", Slot: 8b}].count
scoreboard players operation @s SML.count += tmp SML.count
