...
execute unless block ~1 ~ ~ minecraft:iron_chain run scoreboard players set result SML.variables 0
execute unless block ~ ~ ~1 minecraft:iron_chain run scoreboard players set result SML.variables 0
execute unless block ~1 ~ ~1 minecraft:iron_chain run scoreboard players set result SML.variables 0
