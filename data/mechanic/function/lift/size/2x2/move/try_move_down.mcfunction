...
function mechanic:lift/size/2x2/move/check_space_down
function mechanic:lift/common/stored_chains/check_four

# if allowed move
execute if score result SML.isValid matches 1 positioned ~-0.5 ~ ~-0.5 run function mechanic:lift/size/2x2/move/move_down
