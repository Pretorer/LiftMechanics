...
execute unless block ~2 ~ ~ minecraft:iron_chain run scoreboard players set result SML.variables 0
execute unless block ~ ~ ~2 minecraft:iron_chain run scoreboard players set result SML.variables 0
execute unless block ~2 ~ ~2 minecraft:iron_chain run scoreboard players set result SML.variables 0
