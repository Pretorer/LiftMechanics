...
execute unless block ~ ~3 ~2 minecraft:iron_chain run scoreboard players set result SML.isValid 0
...
execute unless block ~2 ~3 ~ minecraft:iron_chain run scoreboard players set result SML.isValid 0
execute unless block ~2 ~3 ~1 #minecraft:air run scoreboard players set result SML.isValid 0
execute unless block ~2 ~3 ~2 minecraft:iron_chain run scoreboard players set result SML.isValid 0
...
execute unless block ~ ~4 ~2 minecraft:iron_chain run scoreboard players set result SML.isValid 0
...
execute unless block ~2 ~4 ~ minecraft:iron_chain run scoreboard players set result SML.isValid 0
execute unless block ~2 ~4 ~1 #minecraft:air run scoreboard players set result SML.isValid 0
execute unless block ~2 ~4 ~2 minecraft:iron_chain run scoreboard players set result SML.isValid 0