...
execute unless block ~3 ~ ~ minecraft:iron_chain run scoreboard players set result SML.variables 0
execute unless block ~ ~ ~3 minecraft:iron_chain run scoreboard players set result SML.variables 0
execute unless block ~3 ~ ~3 minecraft:iron_chain run scoreboard players set result SML.variables 0
