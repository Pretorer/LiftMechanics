...
execute unless block ~ ~3 ~3 #minecraft:chains run scoreboard players set result SML.isValid 0
...
execute unless block ~3 ~3 ~3 #minecraft:chains run scoreboard players set result SML.isValid 0
...
execute unless block ~3 ~4 ~3 #minecraft:chains run scoreboard players set result SML.isValid 0