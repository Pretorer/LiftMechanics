...
execute at @e[tag=ray_hit_marker] align xyz run function mechanic:interaction/brake/create_marker

kill @e[tag=caller_marker,scores={SML.onLift=0}]

# reset
advancement revoke @s only mechanic:interaction/placed_observer
