...
execute at @e[tag=ray_hit_marker] align xyz run function mechanic:interaction/bulb/create_marker

# reset
advancement revoke @s only mechanic:interaction/placed_bulb